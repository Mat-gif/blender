...
function createTitle(myList,size,title) {
  ...
  function ecrireHtml() {
    ...
    videos.forEach(video => {
      node.innerHTML += createVideoElement(video);
    });
  }
...
var correspondance = {
  ...
  modif : "Dans 'Ajouter Modifier' choisir 'Biseau' et moidifier les parametre au choix ",
  repet: "Repeter pour chacune des éléments",
  ...
  addC : " Alignement = Vue, Verticles =8, Ajuster le radian 0.3",
  ShiftCd : "Shift + Clic droit : Deplacer le curseur 3d",
  cercle :  "Choisir un cercle",
  cube :  "Choisir un cude",
